...
const core_1 = require("@nestjs/core"); // Updated import path
let LocalUserGuard = class LocalUserGuard {
    constructor(userService, jwtService, reflector) {
    ...
    canActivate(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const user = yield this.userService.findUserByEmail(decoded.email);
            if (!user) {
                throw new common_1.ForbiddenException("User not found in local database");
            }
            return true;
        });
    }
...
//# sourceMappingURL=local-user.guard.js.map